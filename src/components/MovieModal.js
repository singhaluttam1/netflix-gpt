...
import data from "../utils/data.json"; // 👈 import JSON

const MovieModal = ({ onClose }) => {
  // For demo, take the first movie in JSON
  useEffect(()=>{
      ...
      <div className="bg-black rounded-lg max-w-4xl w-full relative overflow-y-auto max-h-[90vh]">
        ...
        <div className="p-6">
          ...
          <div className="flex gap-4 mt-6">
            ...
            <button className="flex items-center gap-2 bg-gray-700 text-white px-6 py-2 rounded-md font-semibold hover:bg-gray-600 transition">
              <FaPlus /> My List
            </button>
            <button
          ...
          <div className="bg-neutral-900 text-white p-6 rounded-2xl mt-8">
            <h2 className="text-2xl font-bold mb-4">
              About <span className="text-yellow-400">{movie.original_title}</span>
            </h2>
