...
const GptSearchPage = () => {
  ...
  const handleGptSearchClick = async () => {
    ...
    try {
      ...
      //Result : Hera Pheri, Dhamaal, Golmaal, Chupke Chupke, Welcome
      // Each movie i have to search in tmdb api
      const data = geminiMovies.map((movie) => searchMoviesOMDB(movie))

      // This will return 5 promises [Promise,Promise,Promise,Promise,Promise]
    ...
    <div className='pt-[30%] md:pt-[10%]'>
      <div className="flex justify-center">
        ...
        >
          ...
          />
          <button
            className="col-span-3 m-4 py-2 px-2 md:px-4 bg-red-700 hover:bg-red-800 text-white rounded-lg text-sm md:text-base transition-colors duration-200"
      ...
      <div className='w-[60%] mx-auto'>{suggestions && (
        <div className="text-white flex bg-black bg-opacity-60 px-4 py-2 rounded-md font-bold text-lg text-center mt-4">
